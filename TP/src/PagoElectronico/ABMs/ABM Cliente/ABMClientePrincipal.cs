    ...
    public partial class ABMClientePrincipal : Form
    {
        ...
        private void dgvClientes_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 15)
            {
                ...
                String domNumero =(dgvClientes.Rows[e.RowIndex].Cells["Cliente_Dom_Numero"].Value.ToString());
                String domPiso = (dgvClientes.Rows[e.RowIndex].Cells["Cliente_Dom_Piso"].Value.ToString());
