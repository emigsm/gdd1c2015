...
namespace PagoElectronico.Operaciones.Depositos
{
    public partial class DepositosPrincipal : Form
    {
        ...
        private void ImporteTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                MessageBox.Show("El campo 'Importe' sólo puede contener números y que sean mayores o iguales a 1", "Problema de ingreso de datos", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                e.Handled = true;
                return;
